...
<body>
  ...
  <div class="left_align_float">
		...
		<div id="more_artists_div">
			...
			<a href="./EstelleAkamine"><div class="artist_cell">
			...
			<a href="./BatesPolandBates"><div class="artist_cell">
			...
			<a href="./RuthKolmanBrophy"><div class="artist_cell">
				<h3>Ruth Brophy</h3>
				<p>
			...
			<a href="./SantieHuckaby"><div class="artist_cell">
			...
			<a href="./PeggyHuff"><div class="artist_cell">
				<h3>Peggy Huff</h3>
				<p>
			...
			<a href="./DonaldClegg"><div class="artist_cell">
				<h3>Donald Clegg</h3>
				<p>
			...
			<a href="./ClaudiaKussano"><div class="artist_cell">
			...
			<a href="./JohnPatton"><div class="artist_cell">
				<h3>John Patton</h3>
				<p>
			...
			<a href="./ToruSugita"><div class="artist_cell">
				<h3>Toru Sugita</h3>
				<p>
			...
			<a href="./PatWilson"><div class="artist_cell">
				<h3>Pat Wilson</h3>
				<p>

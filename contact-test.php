...
<body>
	<div id="wrapper">
		...
		<div class="left_align_narrow" id="form_container">
			...
			$subject = isset($_POST['subject']) ? treat_post($_POST['subject']) : '';
			$name = isset($_POST['name']) ? treat_post($_POST['name']) : '';
			$email_address = isset($_POST['email_address']) ? treat_post($_POST['email_address']) : '';
			$msg = isset($_POST['message']) ? treat_post($_POST['message']) : '';

...
<body>
	...
	<div class="left_align_float">
		...
		<h2><a href="http://www.donaldclegg.com">Donald Clegg</a></h2>
		<h4>CONTACT INFORMATION:</h4>
		<a href="mailto:info@donaldclegg.com">email</a><br />
		<a href="http://www.donaldclegg.com">Website</a>

		<div class="float_right_bordered">
			<img src="image/clegg/winter_medley_7.jpg" alt="Winter Medley #7" />
			<div class="center">
				"Winter Medley #7"<br />
		...
		<div class="float_left_bordered">
			<img src="image/clegg/garden_medley_9.jpg" alt="Garden Medley #9" />
			<div class="center">
				"Garden Medley #9"<br />
				transparent watercolor<br />
				size: 22" h x 30" w

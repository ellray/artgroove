...
<body>
  <?php include "../../templates/nav_header.html"; ?>
	<div class="left_align_narrow">
		<div class="center">
			<a href="./crash4.php"><img id="crash_left_arrow" onmousedown="change_image(this.id, '../../images/arrow_left_active.gif')" 
				onmouseup="change_image(this.id, '../../images/arrow_left_red.gif')" src="../../images/arrow_left_red.gif" alt="Previous" /></a>
			<img src="../../images/crash/crash5.jpg" alt="In Memory, V" />
			<a href="./crash6.php"><img id="crash_right_arrow" onmousedown="change_image(this.id, '../../images/arrow_right_active.gif')" 

  ...
  <body>
		<div id="wrapper">
			...
			<div class="left_align_float" style="font-size: 105%">
				...
				<p><span class="bold_red">General Information:</span>  Since Carolyn's death in April 2002, we have created a database of all of her known works.  Where possible, each entry in the database includes an image and information such as the title, size, medium, and date.  As of 2007, we have more than 1900 pieces catalogued.  If you have art by Carolyn not included in the Online Gallery, please let us know using the <a href="./Contact">Contact</a> form.  Images in the Gallery can be expanded by clicking the image; a larger version will appear in a &quot;shadowbox&quot;.  
				</p>
				<p>
				<span class="bold_red">Availability:</span> We provide a selection of Carolyn's art for sale here on <span class="bold">artgroove.com</span>, which will change periodically.  To receive email notification when additional works are made available for purchase, please <a href="./Subscribe"><span class="bold">subscribe</span></a> to our email list.  Your email address remains private -- we do not share email address information with anyone, and each update email we send to you will include a link to remove your email address.
				</p>
				<p>We are also open to discussing purchase of works not currently listed for sale.  Simply contact us via the <a href="./Contact"> Contact </a> form.
				</p>
				<p>
				...
				<p>
				For further information, you can always send us email using this <a href="./Contact">Contact</a> form.
				</p>
				<p>
